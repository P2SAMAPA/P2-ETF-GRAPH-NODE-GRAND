"""
Streamlit UI for P2-ETF-GRAPH-NODE-GRAND.
"""
...
st.set_page_config(page_title="GRAND Engine", layout="wide")
...
st.markdown('<div class="main-header">GRAND — Graph Neural Diffusion ETF Engine</div>', unsafe_allow_html=True)
st.markdown('<div class="sub-header">Continuous Diffusion · Neural ODE · Graph PDE</div>', unsafe_allow_html=True)
